...
pub mod tests {
    ...
    pub fn test_ioctl_req_parses() {
        let message = plain_tests::decode_content(&[
    ...
    pub fn test_ioctl_req_write() {
        let encoded = plain_tests::encode_content(Content::IoctlRequest(IoctlRequest {
            ctl_code: FsctlCodes::PipeTransceive as u32,
            file_id: [
    ...
    pub fn test_ioctl_res_parse() {
        ...
        let message = plain_tests::decode_content(&data);
        let message = match message.content {
